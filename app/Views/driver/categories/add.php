                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a class="active" href="javascript:void(0)"><?= lang('Admin.add_category') ?></a></li>
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= base_url('admin/categories/add') ?>" method="post" accept-charset="utf-8" id="addCategory" enctype="multipart/form-data">
