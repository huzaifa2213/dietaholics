                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
                                <img  src="<?=base_url('backend/images/owner.png')?>" height="700px" alt="Forgot password V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Forgot password-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-forgot-password-form mt-2" accept-charset="utf-8" method="post" action="<?= base_url('owner/forgot-password') ?>">
                                    <div class="mb-1">
                                        <label class="form-label" for="forgot-password-email"><?= lang('Owner.email_id') ?></label>
                                        <input class="form-control" id="forgot-password-email" name="email" placeholder="<?= lang('Owner.enter_email_id') ?>" value="<?= set_value('email') ?>" aria-describedby="forgot-password-email" autofocus="" tabindex="1" required />
                                    </div>
                                    <button class="btn btn-primary w-100" tabindex="2"><?= lang('Owner.send') ?></button>
                                </form>
                                <p class="text-center mt-2"><a class="login-anchor" href="<?= base_url('owner/login') ?>"><i data-feather="chevron-left"></i> <?= lang('Owner.back_to_login') ?>?</a></p>
                            </div>
                        </div>
                        <!-- /Forgot password-->
                    </div>
