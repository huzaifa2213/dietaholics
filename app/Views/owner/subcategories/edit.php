                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="javascrit:void(0)" class="active"><?=lang('Admin.edit_product')?></a></li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /# column -->
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= base_url('admin/subcategories/edit/'.$results['id']) ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="addSubcategory">
                                    <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="title" class="form-control required" type="text" name="title" value="<?=urldecode($results['title'])?>" placeholder="<?=lang('Admin.enter_title')?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <label class="customRadio"><?=lang('Admin.veg')?>
                                                            <input type="radio" <?= $results['type'] == '1' ? 'checked' : '' ?> name="type"  value="1">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea id="description" class="form-control required" name="description" placeholder="<?=lang('Admin.enter_description')?>"><?=urldecode($results['description'])?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
