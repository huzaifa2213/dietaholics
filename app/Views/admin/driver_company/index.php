                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card alert">
                            ...
                            <div class="pull-right">
                                <a class="btn btn-success btn-flat m-b-10 m-l-5" style="margin-right:15px!important" href="<?= base_url('admin/driver_company') ?>/add"><?= lang('Admin.add_driver') ?></a>
                                <input class="btn btn-danger btn-flat m-b-10 m-l-5" type="submit" onclick="multiple_delete('<?= base_url('admin/driver_company') ?>/multiple_delete')" id="postme" value="<?= lang('Admin.delete') ?>" disabled="disabled">
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?= lang('Admin.identity_number') ?></th>
                                            <th><?= lang('Admin.owner_id_number') ?></th>
                                            <th><?= lang('Admin.email_id') ?></th>
                                            <th><?= lang('Admin.license_number') ?></th>
                                        ...
                                        if (!empty($results)) {
                                            foreach ($results as $single) { ?>
                                                <tr id="id_<?= $single['id'] ?>">
                                                    ...
                                                    <td><?= urldecode($single['identity_number']) ?></td>
                                                    <td><?= urldecode($single['owner_id_number']) ?></td>
                                                    <td><?= urldecode($single['company_email_id']) ?></td>
                                                    <td><?= urldecode($single['license_number']) ?></td>
                                                    <td><?= $single['company_contact_number'] ?></td>
                                                    ...
                                                    <td>&nbsp;&nbsp;<a class="ti-pencil-alt" data-toggle="tooltip" style="color: #00c0ef;" title="<?= lang('Admin.edit') ?>!" href="<?= base_url('admin/driver_company') ?>/edit/<?= $single['id'] ?>"></a>&nbsp;&nbsp;<a href="javascript:void(0)" class="ti-trash" style="color:red" data-toggle="tooltip" title="<?= lang('Admin.delete') ?>!" onclick="delete_status('<?= base_url('admin/driver_company') ?>/delete', '<?= $single['id'] ?>')"></a>&nbsp;&nbsp</td>
                                                </tr>
                                        <?php }
                                        } ?>
                                    </tbody>
