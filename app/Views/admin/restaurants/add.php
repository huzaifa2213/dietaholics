                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a class="active" href="javascript:void(0)"><?=lang('Admin.add_restaurant')?></a></li>
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= base_url('admin/restaurants') ?>/add" method="post" accept-charset="utf-8" id="addOwner" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="opening_time" class="form-control required" type="time" name="opening_time" placeholder="<?=lang('Admin.enter_opening_time')?>"  value="<?= set_value('opening_time') ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="closing_time" class="form-control required" type="time" name="closing_time" placeholder="<?=lang('Admin.enter_closing_time')?>" value="<?= set_value('closing_time') ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input id="average_price" class="form-control" type="number" name="average_price" placeholder="<?=lang('Admin.enter_average_price')?>" value="0.00" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="form-control file-input dark-browse-input-box">
                                                        <label for="inputFile-2">
                                                            <span class="btn btn-danger dark-input-button image-custom">
                                                                ...
                                                                <input type="file" name="profile_image" id="inputFile-2" onchange="validateresImage()">
