...
<head>
	...
	<title> Galaxy1344 - Script Installer</title>
	<!-- favicon -->
...
<body>
	...
	<?php
		...
		if(file_exists("../public/setup.txt") && $_GET['step']!='completed') {
	...
	$extensions = [
		'openssl', 'pdo', 'mbstring', 'JSON', 'cURL', 'fileinfo'
	];
				...
				<div class="installer-wrapper">
					<div class="installer-box">
						<div class="heading-area">
							<h4 class="title">
								<i class="fas fa-cogs"></i> Galaxy1344 Installer
							</h4>
						</div>
						<div class="content">
							...
							<div class="main-content">
								<div class="tab-content" id="pills-tabContent">
										...
										<div class="inner-box">
											<ul class="list-group">
												...
												if ($step == 2) {
													...
													if ($phpversion == true) {
														$error = $error + 0;
														printResult("PHP", "Required PHP version 7.3.0 or higher", 1);
													} else {
														$error = $error + 1;
														printResult("PHP", "Required PHP version 7.3.0 or higher", 0);
													}
									...
									<div class="tab-pane fade <?= $step == 'completed' ? 'show active' : '' ?>" id="pills-stap4" role="tabpanel" aria-labelledby="pills-stap4-tab">
											...
											<div class="info-table">
												<table class="table">
													<tr>
														...
														<td>
															<a href="javascript:void(0)"><?= $base_url.'/webservices' ?></a>
														</td>
													</tr>
													<tr>
														<td>
															Restaurant Owner's API link
														</td>
														<td>
															:
														</td>
														<td>
															<a href="javascript:void(0)"><?= $base_url.'/owners_service' ?></a>
														</td>
													</tr>
													<tr>
														<td>
														...
														<td>
															<a href="javascript:void(0)"><?= $base_url.'/drivers' ?></a>
														</td>
													</tr>
													<tr>
														<td>
														...
														<td>
															<a href="<?= $base_url ?>/admin/dashboard"><?= $base_url ?>/admin/dashboard</a>
														</td>
													</tr>
													<tr>
														<td>
													...
													<tr>
														...
														<td>
															<a href="<?= $base_url ?>/owner"><?= $base_url ?>/owner</a>
														</td>
													</tr>
										...
										<div class="footer-area">
											<a href="<?= $base_url ?>/admin" class="next-btn">Complete the process<i class="fas fa-chevron-right"></i> </a>
										</div>
									</div>
