...
class Session implements SessionInterface
{
	 ...
	 * key/value pairs for getFlashdata properties.
	 * Otherwise, it is interpreted as the identifier of a specific
	 * getFlashdata property, with $value containing the property value.
	 *
	 ...
	 *
	 * If the item key is null, return all getFlashdata.
	 *
	...
	public function getFlashdata(string $key = null)
	{
		...
		if (! empty($_SESSION['__ci_vars']))
		{
			foreach ($_SESSION['__ci_vars'] as $key => &$value)
			{
				is_int($value) || $getFlashdata[$key] = $_SESSION[$key];
			}
		}
	...
	/**
	 * Mark a session property or properties as getFlashdata.
	 *
	 * @param array|string $key Property identifier or array of them
	 *
	...
	/**
	 * Unmark data in the session as getFlashdata.
	 *
	...
	/**
	 * Retrieve all of the keys for session data marked as getFlashdata.
	 *
	 * @return array	The property names of all getFlashdata
	 */
